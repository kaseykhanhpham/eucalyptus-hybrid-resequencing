'''
Usage: python dadi_snm.py
For running param optimization for demographic model for totally neutral evol
...
# 01. Standard Neutral Model
for i in range(1,6):
   Optimize_Functions.Optimize_Routine(fs, pts, "{PREFIX}_run{NUM}".format(PREFIX = prefix, NUM = i), "snm", dadi.Demographics1D.snm, rounds, 0, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "")
