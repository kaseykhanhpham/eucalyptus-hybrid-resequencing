...
For running param optimization for demographic model for exponential size change
...
# 02. Growth
for i in range(1,6):
   Optimize_Functions.Optimize_Routine(fs, pts, "{PREFIX}_run{NUM}".format(PREFIX = prefix, NUM = i), "growth", dadi.Demographics1D.growth, rounds, 2, fs_folded=fs_folded, reps=reps, maxiters=maxiters, folds=folds, param_labels = "nu, T")
