# python script to average r2 for each pairwise distance between SNPs in a plink r2 output file
# most appropriate to run via job scheduler since it will require about as much RAM as the size of the plink output file.
...
for line in infile:
    ...
    # append R2 to list
    all_r2_dict[snp_dist].append(float(line_cols[6]))
