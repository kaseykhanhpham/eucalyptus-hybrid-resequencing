...
chr06b2_3_13_het_pres <- ggplot(chr06b2_3_13_df, aes(window, acc, fill = het_mat)) + 
              geom_tile(color = "#005267") + 
              scale_fill_steps(high = "#ffd966", low = "#007c9b") + 
              guides(fill = guide_coloursteps(title = NULL, show.limits = TRUE)) +
              ggtitle("At least one locus with 95% E. cordata ancestry") + 
              xlab("Chromosome 06 Window") + ylab("E. globulus Sample") + 
              scale_x_discrete(breaks = c("Chr06_13139453_13144566", "Chr06_13185479_13190593"), labels = c("13139453", "13190593")) + theme(axis.text=element_text(size=20), axis.title=element_text(size=22), plot.title=element_text(size=28), legend.text=element_text(size=14), legend.title=element_text(size=18))
chr06b2_3_13_het_pres
...
# for July 2023 Presentations
chr07b1_1_59_het_pres <- ggplot(chr07b1_1_59_df, aes(window, acc, fill = het_mat)) + 
              geom_tile(color = "#005267") + 
              scale_fill_steps(high = "#ffd966", low = "#007c9b") + 
              guides(fill = guide_coloursteps(title = NULL, show.limits = TRUE)) +
              ggtitle("At least one locus with 95% E. cordata ancestry") + 
              xlab("Chromosome 07 Window") + ylab("E. globulus Sample") + 
              scale_x_discrete(breaks = c("Chr07_217013_223794", "Chr07_481511_488277"), labels = c("217013", "488277")) + theme(axis.text=element_text(size=20), axis.title=element_text(size=22), plot.title=element_text(size=28), legend.text=element_text(size=14), legend.title=element_text(size=18))
chr07b1_1_59_het_pres
...
# For July 2023 Presentations
chr07b1_7_1112_het_pres <- ggplot(chr07b1_7_1112_df, aes(window, acc, fill = het_mat)) + 
              geom_tile(color = "#005267") + 
              scale_fill_steps(high = "#ffd966", low = "#007c9b") + 
              guides(fill = guide_coloursteps(title = NULL, show.limits = TRUE)) +
              ggtitle("At least one locus with 95% E. cordata ancestry") + 
              xlab("Chromosome 07 Window") + ylab("E. globulus Sample") + 
              scale_x_discrete(breaks = c("Chr07_7052849_7058274", "Chr07_7155943_7161354"), labels = c("7052849", "7161354")) + theme(axis.text=element_text(size=20), axis.title=element_text(size=22), plot.title=element_text(size=28), legend.text=element_text(size=14), legend.title=element_text(size=18))
chr07b1_7_1112_het_pres
...
chr08b2_67_1012_het_pres <- ggplot(chr08b2_67_1012_df, aes(window, acc, fill = het_mat)) + 
              geom_tile(color = "#005267") + 
              scale_fill_steps(high = "#ffd966", low = "#007c9b") + 
              guides(fill = guide_coloursteps(title = NULL, show.limits = TRUE)) +
              ggtitle("At least one locus with 95% E. cordata ancestry") + 
              xlab("Chromosome 08 Window") + ylab("E. globulus Sample") + 
              scale_x_discrete(breaks = c("Chr08_22328249_22338781", "Chr08_22739036_22749536"), labels = c("22328249", "22749536")) + theme(axis.text=element_text(size=20), axis.title=element_text(size=22), plot.title=element_text(size=28), legend.text=element_text(size=14), legend.title=element_text(size=18))
chr08b2_67_1012_het_pres
```
...
chr06_5k_mat_df <- populate_mat(glob_mr_samples, chr06_5k_tab[chr06_5k_to_keep,])
...
chr07_5k_mat_df <- populate_mat(glob_mr_samples, chr07_5k_tab[chr07_5k_to_keep,])
...
chr08_5k_mat_df <- populate_mat(glob_mr_samples, chr08_5k_tab[chr08_5k_to_keep,])
...
### Characterize intervals of interest
