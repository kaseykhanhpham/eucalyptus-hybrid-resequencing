...
# Iterate through each introgressed sample
for sample in struct_json["cluster1"]["eglob_mr"]:
    # create population structure and ComputeStates instance for each introgressed sample and calculate stats
    sample_json = {"cluster1":{"eglob_ref":struct_json["cluster1"]["eglob_ref"], "eglob_mr":{sample:struct_json["cluster1"]["eglob_mr"][sample]}}}
    pop_struct = egglib.struct_from_dict(sample_json, outgr_json)
